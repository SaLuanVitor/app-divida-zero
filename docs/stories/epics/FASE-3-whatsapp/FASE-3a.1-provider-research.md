...
**Acceptance Criteria:**
- [x] Pesquisa comparativa com tabela de 11 critérios (custo, rate limit, compliance, docs, suporte BR)
- [ ] POC funcional com o provedor escolhido (enviar mensagem template real)
- [x] Documento de decisão salvo em `docs/research/YYYY-MM-DD-whatsapp-providers/`
- [x] Provider SDK/adapter base integrado ao projeto
- [x] `WHATSAPP_PROVIDER`, `WHATSAPP_API_KEY`, `WHATSAPP_PHONE_ID` no `.env.example`
