...
class Api::V1::Bank::StatementsControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @ofx_file = fixture_file_upload('sample.ofx', 'application/ofx')
    @csv_file = fixture_file_upload('sample.csv', 'text/csv')
  end

  test 'should return 403 when manual_import disabled' do
    FeatureFlag.disable('manual_import')

    post upload_api_v1_bank_statements_url, headers: @headers, params: { file: @ofx_file }
  ...
  test 'should upload CSV and return batch_id' do
    ...
    post upload_api_v1_bank_statements_url, headers: @headers, params: { file: @csv_file }
    assert_response :accepted
  ...
  test 'should reject unsupported file format' do
    ...
    post upload_api_v1_bank_statements_url, headers: @headers, params: { file: txt_file }
    assert_response :unprocessable_entity
  end

  test 'should reject file too large' do
    FeatureFlag.enable('manual_import')
    large_file = fixture_file_upload('large.ofx', 'application/ofx')

    post upload_api_v1_bank_statements_url, headers: @headers, params: { file: large_file }
    assert_response :unprocessable_entity
  end
  ...
  test 'should return status for valid batch_id' do
    ...
    get status_api_v1_bank_statement_url(batch_id: batch_id), headers: @headers
    assert_response :ok
  ...
  test 'should return 404 for invalid batch_id' do
    ...
    get status_api_v1_bank_statement_url(batch_id: 'invalid'), headers: @headers
  ...
  test 'should delete import batch' do
    ...
    delete api_v1_bank_statement_url(batch_id: batch_id), headers: @headers
    assert_response :ok
  end
end