  ...
  module V1
    module Bank
      class TransactionsController < ApplicationController
        ...
        before_action :check_manual_import_enabled
        ...
        def check_manual_import_enabled
          unless FeatureFlag.enabled?(:manual_import)
            render json: { error: "Importação manual desabilitada" }, status: :forbidden
          end
        end
