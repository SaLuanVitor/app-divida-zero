        ...
        def limits_info(user)
          {
            connections: {
              ...
              limit: user.plan&.limit_for('connections.max_per_user') || PlanLimit.connections_max_per_user,
            ...
            accounts: {
              ...
              limit: user.plan&.limit_for('accounts.max_per_user') || PlanLimit.accounts_max_per_user,
