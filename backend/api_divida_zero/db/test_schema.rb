...
ActiveRecord::Schema[8.1].define(version: 2026_08_21_105529) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.string "email", null: false
    t.json "email_notification_preferences", default: {}, null: false
    ...
    t.json "push_preferences", default: {}, null: false
    t.datetime "reset_password_sent_at"
    t.string "reset_password_token_digest"
    t.string "role", default: "user", null: false
    t.datetime "updated_at", null: false
    t.integer "wa_consecutive_429_count", default: 0, null: false
    t.json "wa_notification_preferences", default: {}, null: false
  ...
  create_table "whatsapp_templates", force: :cascade do |t|
    t.json "components", default: [], null: false
    t.datetime "created_at", null: false
