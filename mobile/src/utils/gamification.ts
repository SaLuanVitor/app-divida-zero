...
export const buildGamificationSummary = ({
  ...
  const achievements: GamificationAchievement[] = [
    {
      ...
      unlocked: recordCount >= 1 || hasAchievementEvent(events, 'first_record'),
    ...
    },
    {
      ...
      unlocked: settledCount >= 1 || hasAchievementEvent(events, 'first_settlement'),
    ...
    },
    {
      ...
      unlocked: recordCount >= 10 || hasAchievementEvent(events, 'ten_records'),
    ...
    },
    {
      ...
      unlocked: settledCount >= 5 || hasAchievementEvent(events, 'five_settled'),
  ...
  const badges: GamificationBadge[] = [
    ...
    {
      id: 'badge_two_settled',
      title: 'Primeiras quitações',
      description: '2 registros concluídos.',
      icon: 'target',
      unlocked: settledCount >= 2,
    },
    {
      id: 'badge_weekly_tracker',
      title: 'Rotina da semana',
      description: 'Cadastre 7 registros no total.',
      icon: 'sprout',
    ...
    },
    {
      id: 'badge_organizer',
      title: 'Organizador',
      description: 'Cadastre 10 registros.',
      icon: 'shield',
    ...
    },
    {
      id: 'badge_finisher',
      title: 'Finalizador',
      description: 'Conclua 10 registros.',
      icon: 'target',
    ...
    {
      id: 'badge_goal_finisher',
      title: 'Meta cumprida',
      description: 'Conclua a primeira meta.',
      icon: 'crown',
      unlocked: completedGoalCount >= 1 || hasAchievementEvent(events, 'first_goal_completed'),
    },
    {
      id: 'badge_before_deadline',
      title: 'Sem atrasos',
      description: 'Conclua uma meta antes do prazo.',
      icon: 'shield',
      unlocked: completedBeforeDeadlineCount >= 1 || hasAchievementEvent(events, 'goal_before_deadline'),
    },
    {
