...
const Metas = () => {
    return (
        <Layout scrollable contentContainerClassName="p-4 bg-[#f8f7f5] dark:bg-black dark:bg-black pb-28">
            <Text className="text-slate-900 dark:text-slate-100 text-2xl font-bold mb-1">Metas</Text>
                ...
                <View className="p-4">
                    <View className="flex-row items-center justify-between mb-3">
                        <View className="flex-row items-center gap-2">
                            ...
                            <Text className="text-slate-900 dark:text-slate-100 font-bold">Quitar cartao Nubank</Text>
                        </View>
                        <Text className="text-primary text-xs font-bold">+1000 XP</Text>
                    </View>

                    <View className="flex-row justify-between mb-2">
                        <Text className="text-slate-500 dark:text-slate-300 text-xs">Concluido</Text>
                        <Text className="text-slate-700 dark:text-slate-200 text-xs font-bold">70%</Text>
                    </View>
                    ...
                    <View className="flex-row justify-between mt-3">
                        <View>
                            <Text className="text-slate-400 dark:text-slate-300 text-xs">Atual</Text>
                            <Text className="text-slate-900 dark:text-slate-100 font-bold">R$ 850,00</Text>
                        </View>
                        <View className="items-end">
                            <Text className="text-slate-400 dark:text-slate-300 text-xs">Meta</Text>
                            <Text className="text-slate-900 dark:text-slate-100 font-bold">R$ 1.200,00</Text>
                        </View>
                    </View>
                </View>
            </Card>
            ...
            <Card className="mb-4" noPadding>
                <View className="p-4">
                    <View className="flex-row items-center gap-2 mb-2">
                        ...
                        <Text className="text-slate-900 dark:text-slate-100 font-bold">Simulador rápido</Text>
                    </View>
                    <Text className="text-slate-500 dark:text-slate-300 text-sm mb-4">Se você adicionar R$ 100 por mês, alcança a meta 2 meses antes.</Text>
            ...
            <Card noPadding>
                <View className="p-4 flex-row items-center justify-between">
                    <View className="flex-row items-center gap-2">
                        ...
                        <Text className="text-slate-900 dark:text-slate-100 font-bold">Criar nova meta</Text>
                    </View>
